                  ...
                  <div className='md:col-span-1'>
                    <div className='px-4 sm:px-0 mb-6'>
                      ...
                      <p className='mt-1 text-xs text-gray-600'>
                        Help us get to know you better. These are questions we
                        ask all new businesses joining PCEPS.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='grid grid-cols-6 gap-6'>
                    <div className='col-span-6 sm:col-span-3'>
                      ...
                      <input
                        ...
                        value={state.firstname.value || stepState.mainFirstName}
                        type='text'
                        name='firstname'
                        id='firstname'
                    ...
                    <div className='col-span-6 sm:col-span-3'>
                      ...
                      <input
                        ...
                        value={state.lastname.value || stepState.mainLastName}
                        type='text'
                        name='lastname'
                        id='lastname'
                    ...
                    <div className='col-span-6 sm:col-span-3'>
                      ...
                      <div className='relative'>
                        <input
                          ...
                          value={
                            state.dateOfBirth.value || stepState.mainDateOfBirth
                          }
                          type='date'
                          name='dateOfBirth'
                    ...
                    <div className='col-span-6 sm:col-span-6 lg:col-span-2'>
                      ...
                      <select
                        ...
                        value={state.region.value || stepState.mainRegionValue}
                        autoComplete='off'
                    ...
                    <div className='col-span-6 sm:col-span-6 lg:col-span-2'>
                      ...
                      <select
                        ...
                        name='province'
                        onChange={city}
                        value={state.province.value || stepState.mainProvince}
                        autoComplete='off'
                        className='mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-orange-400 focus:border-orange-400 sm:text-sm'
                      >
